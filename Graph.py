...
# def load_osmnx_files(starting_nodes_csv_file="", ending_nodes_csv_file="", edge_length_file = ""):
def load_osmnx_files(starting_nodes_csv_file, ending_nodes_csv_file, edge_length_file):
    ...
    return starting_nodes_csv, ending_nodes_csv, edge_length_csv
...
def graph(starting_nodes_csv_file="", ending_nodes_csv_file="", edge_length_file = "", csv_export = False):
    ...
    starting_nodes_csv, ending_nodes_csv, edge_length_csv = load_osmnx_files(starting_nodes_csv_file,
...
def nx_Graph(starting_nodes_csv_file="", ending_nodes_csv_file="", edge_length_file="", display=False):
